...
/* Tujuan : Menyambungkan 1 Node baru(PNew) setelah node dengan nilai tertentu */
/* IS : p mungkin Kosong */
/* FS : Insert PNew setelah node yang memiliki info=nilai, jika ditemukan */
/* Jika nilai tidak ditemukan pada list, tidak ada operasi */
